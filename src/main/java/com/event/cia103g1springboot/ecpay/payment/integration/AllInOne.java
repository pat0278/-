package com.event.cia103g1springboot.ecpay.payment.integration;
...
import com.event.cia103g1springboot.ecpay.payment.integration.domain.ATMRequestObj;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.AioCheckOutALL;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.AioCheckOutATM;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.AioCheckOutApplePay;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.AioCheckOutBARCODE;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.AioCheckOutCVS;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.AioCheckOutDevide;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.AioCheckOutOneTime;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.AioCheckOutPeriod;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.AioCheckOutWebATM;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.CVSOrBARCODERequestObj;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.CreateServerOrderObj;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.DoActionObj;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.FundingReconDetailObj;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.InvoiceObj;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.QueryCreditCardPeriodInfoObj;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.QueryTradeInfoObj;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.QueryTradeObj;
import com.event.cia103g1springboot.ecpay.payment.integration.domain.TradeNoAioObj;
import com.event.cia103g1springboot.ecpay.payment.integration.ecpayOperator.EcpayFunction;
import com.event.cia103g1springboot.ecpay.payment.integration.errorMsg.ErrorMessage;
import com.event.cia103g1springboot.ecpay.payment.integration.exception.EcpayException;
import com.event.cia103g1springboot.ecpay.payment.integration.verification.VerifyAioCheckOut;
import com.event.cia103g1springboot.ecpay.payment.integration.verification.VerifyCreateServerOrder;
import com.event.cia103g1springboot.ecpay.payment.integration.verification.VerifyDoAction;
import com.event.cia103g1springboot.ecpay.payment.integration.verification.VerifyFundingReconDetail;
import com.event.cia103g1springboot.ecpay.payment.integration.verification.VerifyQueryCreditTrade;
import com.event.cia103g1springboot.ecpay.payment.integration.verification.VerifyQueryTrade;
import com.event.cia103g1springboot.ecpay.payment.integration.verification.VerifyQueryTradeInfo;
import com.event.cia103g1springboot.ecpay.payment.integration.verification.VerifyTradeNoAio;
